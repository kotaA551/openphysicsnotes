...
$$
D = \frac{1}{d}\int_{0}^{\infty} dt\;\langle \boldsymbolf v(t)\cdot \boldsymbol v(0)\rangle
$$
...
$$
n(\boldsymbol r,t) = \int d^{3}v\, f,\quad
\boldsymbol u(\boldsymbol r,t) = \frac{1}{n}\int d^{3}v\, \boldsymbol v\, f,\quad
\varepsilon(\boldsymbol r,t) = \int d^{3}v\, \tfrac{1}{2} m v^{2}\, f
$$
...
<RelatedBooks
  items={[
    { title: "Quantum Gravity (Carlo Rovelli)", href: "https://www.amazon.co.jp/dp/0521837332/?tag=YOURTAG-22" },
    { title: "Three Roads to Quantum Gravity (Lee Smolin)", href: "https://www.amazon.co.jp/dp/0465094543/?tag=YOURTAG-22" },
  ]}
/>
