...
$$
m_1 \ddot{\mathbf r}_1 = \mathbfc F_{12}, \quad m_2 \ddot{\mathbfc r}_2 = \mathbf F_{21}
$$

Adding:

$$
m_1 \ddot{\mathbfc r}_1 + m_2 \ddot{\vec r}_2 = \mathbf F_{12} + \mathbfc F_{21} = 0
$$
...
$$
\mathbf P = \frac{\partial L}{\partial \dot{\mathbfc r}} = m \mathbf v
$$
