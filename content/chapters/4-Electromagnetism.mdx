...
$$
\oint \boldsymbol B \cdot d\boldsymbol l = \mu_0 I_{\text{enc}}.
$$
...
$$
\Phi_B = \int \boldsymbol B \cdot d\boldsymbol A.
$$
...
1. **Gauss’s law (electric field).**<br />
   $\displaystyle \nabla \cdot \boldsymbol{E} = \frac{\rho}{\varepsilon_0}$<br />
   Electric charges $\rho$ are sources of electric field.

2. **Gauss’s law (magnetism).**<br />
   $\displaystyle \nabla \cdot \boldsymbol{B} = 0$<br />
   No magnetic monopoles exist; field lines are closed loops.

3. **Faraday’s law of induction.**<br />
   $\displaystyle \nabla \times \boldsymbol{E} = -\,\frac{\partial \boldsymbol{B}}{\partial t}$<br />
   Time-varying magnetic fields induce electric fields.

4. **Ampère–Maxwell law.**<br />
   $\displaystyle \nabla \times \boldsymbol{B} = \mu_0 \boldsymbol{J} + \mu_0 \varepsilon_0 \,\frac{\partial \boldsymbol{E}}{\partial t}$<br />
   Currents and changing electric fields generate magnetic fields.

The crucial addition is the **displacement current term** ($\mu_0 \varepsilon_0 \partial \boldsymbol E/\partial t$), invented by Maxwell to preserve charge conservation. Without it, Ampère’s law fails in cases like charging a capacitor. With it, the equations gain consistency and symmetry.

---

### 4.4.3 The Wave Equation and the Nature of Light

Combine Faraday’s and Ampère–Maxwell’s laws in free space ($\rho=0$, $\boldsymbol J=0$). Taking the curl of Faraday’s law:
...
$$
\nabla \times (\nabla \times \boldsymbol E) = - \mu_0 \varepsilon_0 \frac{\partial^2 \boldsymbolf E}{\partial t^2}.
$$

Using vector identity $\nabla \times (\nabla \times \boldsymbol E) = \nabla(\nabla \cdot \boldsymbol E) - \nabla^2 \boldsymbol E$ and Gauss’s law ($\nabla \cdot \boldsymbol E = 0$ in free space):

$$
\nabla^2 \mathbf E = \mu_0 \varepsilon_0 \frac{\partial^2 \boldsymbol E}{\partial t^2}.
$$
...
Maxwell’s equations are symmetric in $\boldsymbol E$ and $\boldsymbol B$, coupled through time variation. They embody local conservation laws: charge, energy, momentum. They abolished the need for “action at a distance.” Forces arise from local fields, not instantaneous influences.
...
Electromagnetic waves are **transverse**: the electric field $\boldsymbol E$ and magnetic field $\boldsymbol B$ are perpendicular to each other and to the direction of propagation $\mathbf k$. In free space:

$$
\boldsymbol E \perp \boldsymbol B, \qquad \boldsymbol E \times \boldsymbol B \parallel \boldsymbol k.
$$

The wave carries energy flux given by the **Poynting vector**:

$$
\boldsymbolf S = \frac{1}{\mu_0}\boldsymbol E \times \boldsymbol B.
$$
...
<RelatedBooks
  items={[
    { title: "Introduction to Electrodynamics (David J. Griffiths)", href: "https://www.amazon.co.jp/s?k=Introduction+to+Electrodynamics+%28David+J.+Griffiths%29&i=digital-text&__mk_ja_JP=%E3%82%AB%E3%82%BF%E3%82%AB%E3%83%8A&crid=2H1GPT4DQ7CIP&sprefix=introduction+to+electrodynamics+david+j.+griffiths+%2Cdigital-text%2C246&linkCode=ll2&tag=openphysicsno-22&linkId=3979b3fcbde6df6521df5fa5625626c3&language=ja_JP&ref_=as_li_ss_tl" },
    { title: "Principles of Electrodynamics", href: "https://www.amazon.co.jp/Principles-Electrodynamics-Dover-Physics-English-ebook/dp/B008TVEFEE?__mk_ja_JP=%E3%82%AB%E3%82%BF%E3%82%AB%E3%83%8A&crid=A6M77ED1H8JM&dib=eyJ2IjoiMSJ9.DQhWAB-r5-9eemHjTvKnZgC_TewwmsRbk1_8rj0snCasqe2_e4FZ6ZQ5vGY9qerM8i1ltWGIIDP_18vg-0VrS9f-OUP5khaO924iTQjTaYSTjKVNlWDqoF9wpwlWd1f60M3yiFVshAiftgzPY9QswO3QCHYUTCjpjpWyieR9QjOH0e3CzMyeh-d1gVhD_BFnn5DFSrb0QJWlB-4-u4q_GdVQSdwQudVJUAquCJU7id8.Ck0kkZsmRzWEn6QAn5Ikh2db6XQmYSr8O44uiMyZjjA&dib_tag=se&keywords=Electrodynamics&qid=1756501148&s=digital-text&sprefix=electrodynamics%2Cdigital-text%2C192&sr=1-2&linkCode=ll1&tag=openphysicsno-22&linkId=60c7953c4522bb8a6ea38bc1a933f82a&language=ja_JP&ref_=as_li_ss_tl" },
