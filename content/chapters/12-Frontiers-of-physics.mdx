# Chapter 12: Frontiers of physics
...
## Historical Anecdote: Chandrasekhar’s Voyage
...
## Timeline of Dark Matter & Energy Discoveries
...
## Maxwell’s Triumph (19th Century)
...
## Historical Anecdote: Salam’s Diplomacy of Science
...
## Quantum Computing: From Feynman to Shor
...
## Historical Anecdote: Dirac’s Logic of Beauty
...
## The Standard Model: A Quantum Gauge Theory
...
|------------|--------|---------|
| I | up ($u$), down ($d$) | electron ($e$), electron neutrino ($\nu_{e}$) |
| II | charm ($c$), strange ($s$) | muon ($\mu$), muon neutrino ($\nu_{\mu}$) |
| III | top ($t$), bottom ($b$) | tau ($\tau$), tau neutrino ($\nu_{\tau}$) |
...
## Historical Anecdote: The Higgs Discovery Day
...
## Large-Scale Structure and Surveys
...
## Historical Anecdote: Eddington’s Eclipse
...
## The Human Stories Behind Physics
...
## The Future of Physics as a Human Enterprise
