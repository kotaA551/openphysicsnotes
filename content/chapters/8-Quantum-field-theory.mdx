...
<RelatedBooks
  items={[
    { title: "Quantum Field Theory: A Very Short Introduction", author: "Tom Lancaster", href: "https://amzn.to/45YIrYk" },
    { title: "An Introduction to Quantum Field Theory", author: "Peskin & Schroeder", href: "https://amzn.to/45SkqBX" },
  ]}
/>
