  ...
  return (
    <main className="prose prose-zinc max-w-none">
      ...
      <p>
        ...
        The next step was monumental. In 1687, Isaac Newton published "Philosophiæ Naturalis Principia Mathematica (Principia)", in which he articulated the three laws of motion and the law of universal gravitation. Suddenly, the same set of equations could explain an apple falling to Earth and the Moon orbiting the Earth. Newton’s universe was a clockwork of precise and deterministic motion. It could be predicted, modeled, and controlled. The age of classical mechanics had arrived, and it would dominate the next two centuries of scientific thought.<br/><br/>
